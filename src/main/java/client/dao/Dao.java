...
public final class Dao {
    ...
    private static final String SQL_SELECT_ALL_ARTICLES = "SELECT article_id,title,body,date,fk_author_id,fk_resource_id," +
            "author.name a_name,surname,country,resource.name r_name,url FROM article INNER JOIN author ON fk_author_id=author_id " +
            "INNER JOIN resource ON fk_resource_id=resource_id";
